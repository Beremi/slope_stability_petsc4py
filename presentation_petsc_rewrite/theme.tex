...
\makeatletter
\newcommand{\deckpagenumbers}{{\ttfamily\usebeamerfont{page number in head/foot}\insertframenumber\kern0.68em/\kern0.68em\inserttotalframenumber}}
...
\newcommand{\plainpagenumberoverlay}{%
  \begin{tikzpicture}[remember picture,overlay]
    ...
    ] at ([xshift=-0.92cm,yshift=0.24cm]current page.south east) {\insertframenumber\kern0.68em/\kern0.68em\inserttotalframenumber};
  \end{tikzpicture}%
}
...
\setbeamertemplate{frametitle}{%
  \nointerlineskip%
  \begin{beamercolorbox}[wd=\paperwidth,ht=0.74cm,dp=0cm,leftskip=0.62cm,rightskip=0.35cm]{frametitle}
    \vbox to 0.74cm{%
      \vfil
...
\setbeamertemplate{footline}{%
  \leavevmode%
  \hbox{%
    \begin{beamercolorbox}[wd=\paperwidth,ht=2.25ex,dp=1.1ex,rightskip=0.92cm]{page number in head/foot}%
      \hfill\deckpagenumbers
    \end{beamercolorbox}%
  }%
}
