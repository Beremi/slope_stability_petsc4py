...
- Element order: `P4`
- Benchmark harness: [bench_tangent_kernels.py](/home/beremi/repos/slope_stability-1/benchmarks/slope_stability_3D_hetero_SSR_default/archive/bench_tangent_kernels.py)
- Mode: `virtual-rank`
...
- `benchmarks/slope_stability_3D_hetero_SSR_default/archive/scale_p4.py --kernels legacy rows`
