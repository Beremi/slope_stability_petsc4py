...
- `benchmarks/slope_stability_3D_hetero_SSR_default/archive/probe_bddc_elastic.py`
- `benchmarks/slope_stability_3D_hetero_SSR_default/archive/compare_preconditioners.py`
