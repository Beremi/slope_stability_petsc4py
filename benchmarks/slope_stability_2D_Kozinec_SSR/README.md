...
are available: direct and indirect. A benchmark with a homogeneous slope is considered. A
heterogeneous slope from the locality Doubrava-Kozinec is considered, see (Sysala et al.,
NAG 2021).
