...
DEFAULT_REPORT_PATH = BENCHMARK_DIR / "comparisons.md"
DEFAULT_ARTIFACT_ROOT = ROOT / "artifacts" / "comparisons" / "3d_hetero_ssr_default" / "secant_newton_precision_omega6p7e6"
...
def _write_report(
    *,
    ...
    lines.append("")
    lines.append("- Base case: `benchmarks/3d_hetero_ssr_default/case.toml`")
...
def main() -> None:
    ...
    problem_override_lines: list[str] = []
    problem_description = "the current default `3d_hetero_ssr_default` case"
    ...
    if override_parts:
        problem_description = (
            "the current default `3d_hetero_ssr_default` case with "
