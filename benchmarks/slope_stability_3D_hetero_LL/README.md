...
This 3D case runs a config-driven limit-load (LL) analysis using asset `3d_hetero_slope` and mesh variant `adaptive_family_b_l1.msh`.
...
- Mesh variant: `adaptive_family_b_l1.msh`
- Profile: `default`
- Analysis: `ll`
- Element order: `P2`
