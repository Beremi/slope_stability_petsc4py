...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--run-mode",
        default="reuse",
        choices=("reuse", "auto", "run"),
        help="Artifact handling for the visualisation notebook. The default avoids launching a solver.",
    )
    parser.add_argument(
        "--mpi-ranks",
        type=int,
        default=None,
        help="MPI ranks to use if --run-mode allows a smoke solve.",
    )
    parser.add_argument(
        "--surface-subdivision",
        type=int,
    ...
    parser.add_argument(
        "--executed-dir",
        type=Path,
        default=ROOT / ".local" / "tmp" / "notebook_visualisation_execution",
