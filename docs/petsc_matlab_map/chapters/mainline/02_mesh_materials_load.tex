...
For the committed 3D benchmark, \petscmod{execution/asset\_case/mechanics\_3d.py}
receives the asset-resolved mesh and problem data through
\petscmod{execution/asset\_case/runner.py}. The sequence is:
\begin{enumerate}
\item resolve \code{3d\_hetero\_slope} and \code{adaptive\_family\_a\_l1.msh}
from \code{case.toml},
\item build the canonical Gmsh mesh through the asset API,
...
\item \petscmod{execution/asset\_case/mechanics\_3d.py} for the exact mainline
assembly order.
\end{itemize}
