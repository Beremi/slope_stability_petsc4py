...
the seepage branch is \textbf{inactive}. The case config selects
\code{analysis = ssr} on asset \code{3d\_hetero\_slope}, which has no seepage
capability, so the mainline 3D PMG solve does not run any hydraulic
