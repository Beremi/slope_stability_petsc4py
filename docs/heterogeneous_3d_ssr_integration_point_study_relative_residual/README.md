...
- Newton stop: `relative_residual = 1e-4`
...
- `heterogeneous_3d_ssr_integration_point_study_relative_residual.tex`: report source

## Usage

```bash
PYTHONPATH=src .venv/bin/python docs/heterogeneous_3d_ssr_integration_point_study_relative_residual/scripts/run_study.py
PYTHONPATH=src .venv/bin/python docs/heterogeneous_3d_ssr_integration_point_study_relative_residual/scripts/build_report_assets.py
make -C docs/heterogeneous_3d_ssr_integration_point_study_relative_residual pdf
```
...
Raw logs and capture outputs are written under `artifacts/heterogeneous_3d_ssr_integration_point_study_relative_residual`.
