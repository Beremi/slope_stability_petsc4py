...
def case_runner_kwargs(cfg: RunCaseConfig) -> tuple[Callable[..., dict], dict]:
    ...
    if resolved.dimension == 3:
        kwargs = {
            ...
            "mesh_variant": resolved.variant_name,
            "profile": profile,
            "mechanics_backend": cfg.execution.mechanics_backend,
            "elem_type": cfg.problem.elem_type,
            ...
            "preconditioner_threads": linear.threads,
            "pc_backend": linear.pc_backend,
            "pmg_profile": linear.pmg_profile,
            "pmg_coarse_mesh_variant": linear.pmg_coarse_mesh_variant,
            "pmg_fine_hierarchy_mode": linear.pmg_fine_hierarchy_mode,
            "pmg_shell_p2_active_ranks": linear.pmg_shell_p2_active_ranks,
            "pmg_shell_p1_active_ranks": linear.pmg_shell_p1_active_ranks,
            "pmg_shell_subcomm_type": linear.pmg_shell_subcomm_type,
            "pmg_shell_fine_ksp_max_it": linear.pmg_shell_fine_ksp_max_it,
            "pmg_shell_p2_ksp_max_it": linear.pmg_shell_p2_ksp_max_it,
            "pmg_shell_p1_pc_type": linear.pmg_shell_p1_pc_type,
            "pmg_shell_p1_redundant_number": linear.pmg_shell_p1_redundant_number,
            "pmg_shell_p1_redundant_ksp_type": linear.pmg_shell_p1_redundant_ksp_type,
            "pmg_shell_p1_redundant_ksp_rtol": linear.pmg_shell_p1_redundant_ksp_rtol,
            "pmg_shell_p1_redundant_ksp_max_it": linear.pmg_shell_p1_redundant_ksp_max_it,
            "pmg_shell_p1_redundant_pc_type": linear.pmg_shell_p1_redundant_pc_type,
