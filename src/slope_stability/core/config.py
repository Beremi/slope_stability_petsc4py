...
class Run3DSSRConfig:
    ...
    def to_run_capture_kwargs(self) -> dict:
        ...
        return {
            ...
            "pc_backend": self.linear_solver.pc_backend,
            "preconditioner_matrix_source": self.linear_solver.preconditioner_matrix_source,
            "preconditioner_matrix_policy": self.linear_solver.preconditioner_matrix_policy,
            "preconditioner_rebuild_policy": self.linear_solver.preconditioner_rebuild_policy,
            "preconditioner_rebuild_interval": self.linear_solver.preconditioner_rebuild_interval,
            ...
            "pc_gamg_aggressive_coarsening": self.linear_solver.pc_gamg_aggressive_coarsening,
            "pc_gamg_aggressive_square_graph": self.linear_solver.pc_gamg_aggressive_square_graph,
            "pc_gamg_aggressive_mis_k": self.linear_solver.pc_gamg_aggressive_mis_k,
            ...
            "pc_hypre_boomeramg_max_iter": self.linear_solver.pc_hypre_boomeramg_max_iter,
            "pc_hypre_P_max": self.linear_solver.pc_hypre_P_max,
            "pc_hypre_agg_nl": self.linear_solver.pc_hypre_agg_nl,
            "pc_hypre_nongalerkin_tol": self.linear_solver.pc_hypre_nongalerkin_tol,
            "pc_bddc_symmetric": self.linear_solver.pc_bddc_symmetric,
            "pc_bddc_dirichlet_ksp_type": self.linear_solver.pc_bddc_dirichlet_ksp_type,
            "pc_bddc_dirichlet_pc_type": self.linear_solver.pc_bddc_dirichlet_pc_type,
            "pc_bddc_neumann_ksp_type": self.linear_solver.pc_bddc_neumann_ksp_type,
            "pc_bddc_neumann_pc_type": self.linear_solver.pc_bddc_neumann_pc_type,
            "pc_bddc_coarse_ksp_type": self.linear_solver.pc_bddc_coarse_ksp_type,
            ...
            "pc_bddc_monolithic": self.linear_solver.pc_bddc_monolithic,
            "pc_bddc_coarse_redundant_pc_type": self.linear_solver.pc_bddc_coarse_redundant_pc_type,
            ...
            "pc_bddc_use_faces": self.linear_solver.pc_bddc_use_faces,
            "pc_bddc_use_change_of_basis": self.linear_solver.pc_bddc_use_change_of_basis,
            "pc_bddc_use_change_on_faces": self.linear_solver.pc_bddc_use_change_on_faces,
            "pc_bddc_check_level": self.linear_solver.pc_bddc_check_level,
